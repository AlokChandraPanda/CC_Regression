...
public class Reports {
	...
	public static void startReport(){
		extent = new ExtentReports (System.getProperty("user.dir") +"/TestReports/"+"TestOne"+".html", true);
		extent  .addSystemInfo("Host Name", "SoftwareTestingMaterial")
                .addSystemInfo("Environment", "Automation Testing")
                .addSystemInfo("User Name", "Rajkumar SM");
                extent.loadConfig(new File(System.getProperty("user.dir")+"\\extent-config.xml"));
                logger = extent.startTest("TestTwo");
	}
	...
	public static void logPASS(String msg) throws IOException{
